					...
					<div className="container">
						...
						<div className="row mb-80">
							<div className="col-md-12" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <ol type="1">
                                    <li>Laboratorium Internet of Things</li>
                                    <li>Laboratorium Computer Networking</li>
                                    <li>Laboratorium Start Up</li>
                                    <li>Laboratorium Computer Vision</li>
                                    <li>Laboratorium Data Science</li>
                                    <li>Laboratorium Multimedia</li>
                                    <li>Laboratorium Microcontroller</li>
                                    <li>Laboratorium Riset 1</li>
                                    <li>Laboratorium Riset 2</li>
                                    <li>Laboratorium Riset 3</li>
                                </ol>
							</div>
                        </div>
					</div>
